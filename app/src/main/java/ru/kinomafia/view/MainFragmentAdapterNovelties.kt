...
class MainFragmentAdapterNovelties(private var onItemViewClickListener: MainFragment.OnItemViewClickListener?) :
                                RecyclerView.Adapter<MainFragmentAdapterNovelties.MainFragmentFilmHolder>(){
